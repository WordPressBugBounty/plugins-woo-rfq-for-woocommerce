...
// add the filter
        ...
        add_filter('woocommerce_email_headers', array($this, 'gpls_rfq_add_reply_to_admin_order'), PHP_INT_MAX - 1, 3);
    ...
    public function gpls_rfq_add_reply_to_admin_order($header, $id, $order)
    {
